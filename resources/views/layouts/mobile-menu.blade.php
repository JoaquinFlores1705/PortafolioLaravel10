    ...
    <div class="container h-full mt-2">
        <div class="flex flex-wrap">
            ...
            <ul class="mt-20 basis-full">
                ...
                <li>
                    <x-link-menu href="/posts/documentación" class="flex separation-bcolor border-third justify-center items-center text-secondary dark:text-white font-bold" :active="request()->is('posts/documentación')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 font-bold">
